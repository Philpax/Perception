	...
	IDirect3DDevice9** ppReturnedDeviceInterface)
{
	...
	Log( "[BaseDirect3D9] Successfully created original device" );
	...
	Log( "[BaseDirect3D9] Successfully loaded configuration" );

	if(cfg.stereo_mode == StereoView::DISABLED)
		return hResult;

	LogF( "[BaseDirect3D9] Stereo mode enabled, game type: %d", cfg.game_type );
