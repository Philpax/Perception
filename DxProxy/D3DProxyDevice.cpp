...
{
	Log( "[D3DProxyDevice] Initialized" );
	yaw_mode = 0;
	pitch_mode = 0;
	roll_mode = 0;
	translation_mode = 0;
...
void D3DProxyDevice::SetupOptions(ProxyHelper::ProxyConfig& cfg)
{
	...
	LogF( "[D3DProxyDevice] Aspect multiplier: %f", cfg.aspect_multiplier );
}
...
void D3DProxyDevice::HandleTracking()
{
	...
	{
		Log( "[D3DProxyDevice] Attempting tracker initialization" );
